...
const COMPOSICION_NORMAL = {
  pindo: [
    { codigo: "PZA-BLA-01", cant: 3 }, { codigo: "PZA-ROJ-02", cant: 1 },
    { codigo: "PZA-ROJ-04", cant: 1 }, { codigo: "PZA-ROJ-08", cant: 1 },
    { codigo: "PZA-AZU-02", cant: 2 }, { codigo: "PZA-AZU-04", cant: 1 },
    { codigo: "PZA-AZU-08", cant: 1 }, { codigo: "PZA-AMA-02", cant: 1 },
    { codigo: "PZA-AMA-06", cant: 1 }, { codigo: "PZA-VER-04", cant: 1 },
    { codigo: "PZA-VER-06", cant: 1 }
  ],
  sanyo: [
    { codigo: "PZA-BLA-01", cant: 3 }, { codigo: "PZA-ROJ-02", cant: 1 },
    { codigo: "PZA-ROJ-04", cant: 1 }, { codigo: "PZA-ROJ-06", cant: 1 },
    { codigo: "PZA-AZU-02", cant: 1 }, { codigo: "PZA-AZU-04", cant: 1 },
    { codigo: "PZA-AZU-06", cant: 1 }, { codigo: "PZA-AMA-02", cant: 1 },
    { codigo: "PZA-AMA-04", cant: 1 }, { codigo: "PZA-AMA-08", cant: 1 },
    { codigo: "PZA-VER-02", cant: 1 }, { codigo: "PZA-VER-04", cant: 1 },
...
const ZONAS_PIEZAS = {
  "Zona 1": {
    pindo: [{ codigo: "PZA-BLA-01", cant: 2 }, { codigo: "PZA-AZU-02", cant: 1 }, { codigo: "PZA-AMA-02", cant: 1 }],
    sanyo: [{ codigo: "PZA-BLA-01", cant: 1 }, { codigo: "PZA-ROJ-04", cant: 1 }, { codigo: "PZA-AZU-06", cant: 1 }, { codigo: "PZA-VER-08", cant: 1 }]
  },
  "Zona 2": {
    pindo: [{ codigo: "PZA-AMA-06", cant: 1 }, { codigo: "PZA-AZU-08", cant: 1 }, { codigo: "PZA-VER-06", cant: 1 }],
    sanyo: [{ codigo: "PZA-ROJ-06", cant: 1 }, { codigo: "PZA-AZU-04", cant: 1 }, { codigo: "PZA-AMA-08", cant: 1 }]
  },
  "Zona 3": {
    pindo: [{ codigo: "PZA-BLA-01", cant: 1 }, { codigo: "PZA-ROJ-02", cant: 1 }, { codigo: "PZA-ROJ-08", cant: 1 }, { codigo: "PZA-AZU-02", cant: 1 }],
    sanyo: [{ codigo: "PZA-BLA-01", cant: 2 }, { codigo: "PZA-ROJ-02", cant: 1 }, { codigo: "PZA-AMA-04", cant: 1 }, { codigo: "PZA-VER-04", cant: 1 }]
  },
  "Zona 4": {
    pindo: [{ codigo: "PZA-ROJ-04", cant: 1 }, { codigo: "PZA-AZU-04", cant: 1 }, { codigo: "PZA-VER-04", cant: 1 }],
    sanyo: [{ codigo: "PZA-AZU-02", cant: 1 }, { codigo: "PZA-AMA-02", cant: 1 }, { codigo: "PZA-VER-02", cant: 1 }]
  }
};
...
io.on('connection', (socket) => {
  ...
  socket.on('nuevo_pedido', (datos) => {
    ...
    const idUnico = contadorPedidos++;
    const nombrePedido = datos.nombrePedido && datos.nombrePedido.trim() !== "" 
      ? datos.nombrePedido.trim() 
      : `Pedido #${idUnico}`;
    ...
    // Agregar al inicio para mantener el orden cronológico descendente
  ...
  socket.on('despachar_pedido', (idOrden) => {
    ...
    if (orden) {
      ...
      // Programar borrado automático en 10 segundos (10000 ms)
      setTimeout(() => {
        pedidos = pedidos.filter(p => p.id !== idOrden);
        io.emit('eliminar_pedido', idOrden);
      }, 10000);
    }
  });
});
